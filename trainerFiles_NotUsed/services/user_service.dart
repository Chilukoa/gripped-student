...
class UserService {
  ...
  // Method to get viewable URL from image key
  String getImageUrl(String imageKey) {
    // Construct the direct S3 URL - this is typically the pattern for S3 URLs
    // You may need to adjust this based on your S3 bucket configuration
    return 'https://gripped-app-images.s3.amazonaws.com/$imageKey';
  }

...
class _TrainerDashboardScreenState extends State<TrainerDashboardScreen> {
  ...
  Future<void> _loadClasses() async {
    try {
      ...
      safePrint('TrainerDashboard: Starting to load classes...');
      final classes = await ClassService().getClassesByTrainer();
      safePrint(
        'TrainerDashboard: Successfully loaded ${classes.length} classes',
      );
      ...
      safePrint('TrainerDashboard: Error loading classes: $e');
      if (mounted) {
        setState(() {
          _error = e.toString();
          _isLoading = false;
  ...
  Future<void> _navigateToClassDetail(TrainingClass trainingClass) async {
    final result = await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ClassDetailScreen(trainingClass: trainingClass),
      ),
    );

    // If class was cancelled or updated, reload the list
    if (result == true) {
      _loadClasses();
    }
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: screenHeight * 0.01),
            Text(
              'You don\'t have any active upcoming classes.\nCreate a new class to start training students!',
              style: TextStyle(
                fontSize: screenWidth * 0.04,
  ...
  Widget _buildClassCard(
    ...
    return Container(
      ...
      child: InkWell(
        onTap: () => _navigateToClassDetail(trainingClass),
        borderRadius: BorderRadius.circular(12),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: screenHeight * 0.005),
                            Text(
                              trainingClass.classTags?.join(', ') ?? 'Fitness',
                              style: TextStyle(
                      ...
                      Text(
                        '\$${trainingClass.pricePerClass.toStringAsFixed(0)}',
                        style: TextStyle(
                          fontSize: screenWidth * 0.05,
                          fontWeight: FontWeight.bold,
                          color: Colors.green,
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          '${_formatDateTime(trainingClass.startTime)} • ${_formatDuration(trainingClass.startTime, trainingClass.endTime)}',
                          style: TextStyle(
                            fontSize: screenWidth * 0.035,
                            color: Colors.grey[600],
                          ),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          '${trainingClass.city ?? ''}, ${trainingClass.state ?? ''}',
                          style: TextStyle(
                            fontSize: screenWidth * 0.035,
                            color: Colors.grey[600],
                          ),
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: screenWidth * 0.02),
                      Text(
                        '${trainingClass.countRegistered}/${trainingClass.capacity} participants',
                        style: TextStyle(
                          fontSize: screenWidth * 0.035,
                          color: Colors.grey[600],
                        ),
                  ...
                  // Description
                  Text(
                    trainingClass.overview ?? 'No description available',
                    style: TextStyle(
                      fontSize: screenWidth * 0.035,
